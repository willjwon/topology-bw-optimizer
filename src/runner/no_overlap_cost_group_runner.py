...
def main():
    ...
    t17b_model = ModelCostNoOverlap(workload_path=t17b_path,
                                    mp_size=1,
                                    dp_size=1024)
    gpt3_model = ModelCostNoOverlap(workload_path=gpt3_path,
                                    mp_size=16,
                                    dp_size=64)
    t1t_model = ModelCostNoOverlap(workload_path=t1t_path,
                                   mp_size=128,
                                   dp_size=8)
